...
- **The live lens set is `FILTER_IDS` in `cardSchema.js` — read it, don't recall it.** It has changed six times since July; a lens you remember may be retired. Authoring a card with an unknown filter fails schema validation.
