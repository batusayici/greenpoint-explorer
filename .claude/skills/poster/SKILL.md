...
1. **Legible?** Anything load-bearing — date, time, address, price — that reads `[illegible]` holds the card. A missing month on a poster that says "Saturday the 12th" is not a date.
