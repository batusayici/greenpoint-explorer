...
| `docs/mvp-reference-images/northwest-grillpoint-deli-wide.jpg` | Batu-supplied owned/non-Google field reference, later normalized from HEIF-wrapped `.jpeg` to readable `.jpg`, EXIF recorded in MVP-19. | Wider NW corner context, building massing, storefront relation, station context. | Review-only; use only if the Stage B raster workflow can inspect it safely. |
| `docs/mvp-reference-images/northwest-grillpoint-deli-facade.jpg` | Batu-supplied owned/non-Google field reference, later normalized from HEIF-wrapped `.jpeg` to readable `.jpg`, EXIF recorded in MVP-19. | Facade-focused NW view. | Review-only. |
| `docs/mvp-reference-images/northwest-subwayA.jpg` | Batu-supplied owned/non-Google field reference, later normalized from HEIF-wrapped `.jpeg` to readable `.jpg`, EXIF recorded in MVP-19. | NW subway/street context. | Review-only; exact station geometry remains unresolved. |
...
- Approved input/reference paths: NW Grillpoint field photos only, `northwest-subwayA.jpg`, and II-A / II-B raster direction references.
