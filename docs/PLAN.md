...
60. 4O-16: QA Scaffold Preview Report And Batu Review Gate. Complete and verified; stop at Batu review gate.
61. 4J: Storefront bay/frontage candidate layer. Deferred; candidate-only and QA-only until later approval after spatial scaffold review.
62. 4K: Business/source linkage. Deferred until storefront/frontage candidates and business source policy are approved.
63. 4L: Evidence-backed QA corridor render. Deferred until evidence and linkage gates support a truthful QA render.
64. 4M: Asset registry / visual system / art-direction translation. Deferred until spatial recognizability is proven and evidence/override models are defined; Qwen/Oxen may be evaluated here only as a source-safe visual-system accelerator.
65. 4N: Normal-mode promotion + recognition QA. Deferred until QA render, spatial scaffold acceptance, provenance, optional asset/art translation, and Batu promotion gates clear.
...
- Batu review decision after the completed 4O-13 -> 4O-16 QA scaffold preview reconnection packet.
- Batu decision on whether to expand the QA-only scaffold preview, correct current container/grounding/height placeholder behavior, open first real source fixture ingestion, request a corrective 4O boundary pass, or pause 4O.
