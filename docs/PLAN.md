...
### Phase 8 — Spine Expansion + Story Attachment — NOW (8.0 + 8.2 done; 8.1 / 8.3 / 8.4 live)
...
- **8.1 Expand along the story-dense spine — NOW (unblocked 2026-06-21).** Extend the procedural scene down the curated corridor (not all of Greenpoint). Hero treatment only on the 6.1 set; everything else typological through the completed kit.
