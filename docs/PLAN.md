...
- Current phase: `Batch 4J-2: QA Runtime Frontage Candidate Overlay` is complete and verified; `Batch 4J-3: Candidate Gap + Readiness Report` is open.
- Docs authority routing: `docs/DOCS_INDEX.md`.
- Current Phase 4 control surface: `docs/phase-4-execution-roadmap.md`.
- Current next task: execute `Batch 4J-3: Candidate Gap + Readiness Report`.
...
67. 4J-3: Candidate gap + readiness report. Open; stop afterward for Batu review.
