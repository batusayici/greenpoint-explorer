...
- Current phase: `Batch 4J-1: Frontage Candidate Contract + Fixture` is complete and verified; `Batch 4J-2: QA Runtime Frontage Candidate Overlay` is open.
- Docs authority routing: `docs/DOCS_INDEX.md`.
- Current Phase 4 control surface: `docs/phase-4-execution-roadmap.md`.
- Current next task: execute `Batch 4J-2: QA Runtime Frontage Candidate Overlay`.
...
- Updated high-level roadmap posture: Batu accepted the 4G-A/4G-B/4H-1 packet and opened a bounded Phase 4I packet. 4I-1 through 4I-4 are complete and verified. 4O-1 through 4O-20 completed the truth-first procedural corridor scaffold path through corridor-wide QA scaffold preview expansion, family controls, and spatial-usefulness review. Batu accepted the 4O-18 -> 4O-20 packet and opened bounded 4J work. 4J-1 added 22 QA-only frontage/bay candidate records mapped to 10 existing 4O building anchors, with all records non-promoted and blocked from normal mode. Real source access/ingestion, normal-mode rendering, public UI, procedural production scaffold rendering, 4K business/source linkage, 4L evidence-backed QA corridor render, 4M asset registry / visual system / art-direction translation, 4N normal-mode promotion + recognition QA, 4P work, and facade evidence intake remain deferred until later Batu gates.
...
66. 4J-2: QA runtime frontage candidate overlay. Open.
67. 4J-3: Candidate gap + readiness report. Pre-authorized queue; stop afterward for Batu review.
