...
- Current phase: Post-4D-1 geometry validation review; no implementation batch is open.
- Docs authority routing: `docs/DOCS_INDEX.md`.
- Current Phase 4 control surface: `docs/phase-4-execution-roadmap.md`.
- Current next task: none; proposed next authorization is `Batch 4D-2: Claim ladder / matching contract`, only after Batu reviews 4D-1.
- Pre-authorized queue: none.
- Hard review gate: stop for Batu review of completed 4D-1. Do not open 4D-2, Foursquare/local-directory work, POI overlays, facade imagery ingestion, storefront anchors, asset registry, visual-system work, or another generic facade tuning batch without Batu approval and an updated current brief/queue.
...
- Phase 4D has begun with completed 4D-1 geometry confidence and gap audit. Claim discipline remains the next proposed step before POIs, facade imagery, storefront anchors, or asset registry work.
...
20. Batch 4D-1: Geometry validation and gap audit. Complete pending Batu review.
21. Batch 4D-2: Claim ladder / matching contract. Proposed next authorization only; not executable until Batu opens it.
...
- Batu review/acceptance decision for completed `Batch 4D-1: Geometry validation and gap audit`, and authorization decision for proposed `Batch 4D-2: Claim ladder / matching contract` or a different next batch.
