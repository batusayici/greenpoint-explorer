...
- Current phase: Phase 2D Source Evidence Fixture is complete for Batu review. MVP-29E Narrow Corrective Pass remains complete for Batu review and does not reopen raster, app, full screenshot-QA, or demo-freeze work.
- Phase 1: MVP Scene Prototype is mostly complete; MVP-29E is pending Batu review/minor positioning corrections.
- Phase 2: Data-Driven Scene MVP is underway; Phase 2A docs-only architecture setup, Phase 2B manifest-driven scene foundation, Phase 2C lightweight manifest QA inspector, and Phase 2D review-only source-evidence fixture spike are complete for review.
...
- Current next recommended state: Batu review/acceptance, revision, or rejection of the Phase 2D source-evidence fixture and QA display. If accepted, Batu may open a later bounded Phase 2 task for normalized source-record expansion, geometry mapping, QA refinement, screenshot regression coverage, or a deliberately scoped ingestion spike. MVP-29E review/acceptance, revision, or rejection remains pending Batu and is not resolved by Phase 2D.
...
- Phase 2: Data-Driven Scene MVP - underway; Phase 2A docs-only architecture setup, Phase 2B manifest-driven scene foundation, Phase 2C manifest QA inspector, and Phase 2D source-evidence fixture spike are complete for review.
...
- Phase 2D - Source Evidence Fixture is complete for Batu review.
- Phase 2D added a review-only source-evidence fixture for Grillpoint Deli and Greenpoint Ave G context, adapter validation, manifest-to-evidence links, and selected-card QA display of evidence-backed claims plus remaining gaps while preserving the existing app interaction shell and review-only raster asset.
- Next recommended state: Batu review/acceptance, revision, or rejection of the Phase 2D source-evidence fixture; if accepted, Batu may open a later bounded Phase 2 task for normalized source-record expansion, geometry mapping, QA refinement, screenshot regression coverage, or a deliberately scoped ingestion spike.
...
- Raster revisions, broader app refactor, ingestion scripts, scraping, external app-code API calls, generated scene data beyond the current review manifest/fixture, package/tooling changes, full MVP-29G screenshot QA, and MVP-30 QA/demo freeze remain blocked unless a later brief explicitly opens them.
...
- Phase 2B/2C/2D are review-only and do not approve the manifest, QA inspector, or source-evidence fixture as a production public interface, runtime schema, ingestion output format, source pipeline, or broader Greenpoint data model.
...
- Whether Batu accepts, revises, or rejects the Phase 2D source-evidence fixture and opens the next bounded Phase 2 task.
