...
- Current next task: none; pending Batu visual review of the completed 4M-R9 Franklin high-recognition detail-module proof.
- Pre-authorized queue: none.
- Hard stop gate: stop after completed 4M-R9 for Batu visual review. Do not open GLB work, Manhattan implementation, Mapillary/KartaView, 4L-External, production 4M asset/art-direction work, 4P, external source access, source download/cache/ingestion/conversion/render use, new evidence intake, normal-mode rendering, public UI, production scaffold rendering, source promotion, exact storefront/frontage/entrance/address/signage/tenant/material/active-status claims, exact height/roof claims, production use, new dependencies, credentials, paid APIs, renderer replacement, public interfaces beyond the internal Franklin QA hero module option, architecture changes, or public/product claims without Batu approval and an updated current brief/queue.
...
87. Mapillary/KartaView source-use gate. Recommended as a proposal only; not open.
88. 4L external/scaled evidence-backed QA corridor render. Deferred until Batu approves source/evidence boundaries and opens a later packet.
89. 4M production asset registry / visual system / art-direction translation. Deferred until Batu opens production visual-system scope; Qwen/Oxen may be evaluated here only as a source-safe visual-system accelerator.
90. 4N: Normal-mode promotion + recognition QA. Deferred until QA render, spatial scaffold acceptance, provenance, optional asset/art translation, and Batu promotion gates clear.
...
- Batu visual review decision after 4M-R9: whether code-native, JSON-driven Franklin detail modules reduce the recognizability gap enough to continue this lane, or whether a later GLB hero-injection lane should be opened. Manhattan remains closed except regression capture if shared renderer code changes.
