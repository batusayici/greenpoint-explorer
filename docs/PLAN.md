...
- Current phase: Phase 2C Manifest QA Inspector is complete for Batu review. MVP-29E Narrow Corrective Pass remains complete for Batu review and does not reopen raster, app, full screenshot-QA, or demo-freeze work.
- Phase 1: MVP Scene Prototype is mostly complete; MVP-29E is pending Batu review/minor positioning corrections.
- Phase 2: Data-Driven Scene MVP is underway; Phase 2A docs-only architecture setup, Phase 2B manifest-driven scene foundation, and Phase 2C lightweight manifest QA inspector are complete for review.
...
- Current next recommended state: Batu review/acceptance, revision, or rejection of the Phase 2C manifest QA inspector. If accepted, Batu may open a later bounded Phase 2 task for normalized source-record work, source ingestion spike work, geometry mapping, QA refinement, or screenshot regression coverage. MVP-29E review/acceptance, revision, or rejection remains pending Batu and is not resolved by Phase 2C.
...
- Phase 2: Data-Driven Scene MVP - underway; Phase 2A docs-only architecture setup, Phase 2B manifest-driven scene foundation, and Phase 2C manifest QA inspector are complete for review.
...
- Phase 2C - Manifest QA Inspector is complete for Batu review.
- Phase 2C added target-level manifest QA data to the adapter and a lightweight selected-card QA inspector that surfaces provenance, confidence, manual overrides, missing data, ambiguity, and blocked claims while preserving the existing app interaction shell and review-only raster asset.
- Next recommended state: Batu review/acceptance, revision, or rejection of the Phase 2C manifest QA inspector; if accepted, Batu may open a later bounded Phase 2 task for normalized source-record work, source ingestion spike work, geometry mapping, QA refinement, or screenshot regression coverage.
...
- Raster revisions, broader app refactor, ingestion scripts, generated scene data beyond the current review manifest, package/tooling changes, full MVP-29G screenshot QA, and MVP-30 QA/demo freeze remain blocked unless a later brief explicitly opens them.
...
- Phase 2B/2C are review-only and do not approve the manifest or QA inspector as a production public interface, runtime schema, ingestion output format, or broader Greenpoint data model.
...
- Whether Batu accepts, revises, or rejects the Phase 2C manifest QA inspector and opens the next bounded Phase 2 task.
