...
- Current next task: none. Stop at the R10G corner-frontage wrap visual review gate; GLB assessment/tuning, hero-kit tuning, R11/R12, Manhattan work, production mode, facade polish, materials, and asset fidelity remain future candidates only.
- Pre-authorized queue: none.
- Hard stop gate: stopped after R10G Franklin corner-frontage wrap implementation for Batu visual review. Do not self-open GLB assessment/tuning, hero-kit tuning, R11/R12, Manhattan implementation, production mode, facade polish, materials, Mapillary/KartaView, 4L-External, production 4M asset/art-direction work, 4P, external source access, source download/cache/ingestion/conversion/render use, new evidence intake, normal-mode rendering, public UI, production scaffold rendering, source promotion, exact storefront/frontage/entrance/address/signage/tenant/material/active-status claims, exact height/roof claims, production use, new dependencies, credentials, paid APIs, renderer replacement, public interfaces beyond the approved internal Franklin QA hero module / candidate hero asset boundary, architecture changes, or public/product claims without later Batu approval and an updated current brief/queue.
- Updated high-level roadmap posture: Batu accepted the 4G-A/4G-B/4H-1 packet and opened a bounded Phase 4I packet. 4I-1 through 4I-4 are complete and verified. 4O-1 through 4O-20 completed the truth-first procedural corridor scaffold path. 4J-1 through 4J-3 added and reviewed QA-only frontage/bay candidates. 4K-1 through 4K-3 added, rendered, and reviewed QA-only recognizable anchor cues. 4L-Prep mapped current 4K gaps to required evidence types and recorded that the repo was not ready for evidence-backed 4L QA corridor render. 4L-Local-1 through 4L-Local-5 are complete and verified. 4M-R5 proved measured/procedural Franklin rendering can reach directional recognizability. 4M-R6 then tested the hybrid hero-corner lane: Franklin-specific opaque final-look modules over the measured trace, with reusable facade/street grammar extracted for later scaling. R6 proved hybrid recognizability but not benchmark render fidelity, so R7 opens a Franklin-only hero kit extraction/render proof: measured trace = alignment, hero kit = visual fidelity, runtime = assembly/review. Franklin remains the current benchmark target; Manhattan follows only if Batu approves that next lane. Real source access/ingestion, normal-mode rendering, public UI, production scaffold rendering, business/source linkage, external 4L evidence-backed QA corridor render, production 4M asset registry / visual system / art-direction translation, 4N normal-mode promotion + recognition QA, 4P work, and new evidence intake remain deferred until later Batu gates.
...
- Phase 4 execution gate: agents may execute only the current batch named in `docs/CURRENT_EXECUTION_BRIEF.md` or the next batch already named in that brief's pre-authorized queue, must use `docs/phase-4-execution-roadmap.md` as the operating plan, and must stop at hard Batu review gates instead of inventing, skipping, or opening unqueued batches. Current gate is the R10G Franklin corner-frontage wrap visual review gate with no pre-authorized queue; GLB assessment/tuning, R11/R12, and Manhattan work remain future candidates only.
- Phase 4O-1 has a planning/implementation note and verifier: `docs/phase-4o-1-truth-first-corridor-data-contract.md` and `scripts/verify-phase-4o-1-truth-first-corridor-data-contract.mjs`. It defines planning-only / fixture-ready record shapes for building footprints, street/sidewalk/curb grounding, height/massing fallback, frontage/corner classification, and manual override slots. Phase 4O-2 through 4O-20 establish and preview the QA-only scaffold path, ending with 26 QA-only spatial records and a spatial-usefulness review pack. Phase 4J-1 adds `src/data/corridor-scaffold/greenpoint-ave-manhattan-to-franklin.phase-4j-1-qa-frontage-candidates.v0.1.json`, `scripts/verify-phase-4j-1-qa-frontage-candidates.mjs`, and `docs/reports/phase-4j-1-frontage-candidate-contract-fixture.md`. Phase 4J-2 updates the existing runtime/styles and adds `scripts/verify-phase-4j-2-qa-frontage-runtime-overlay.mjs` plus `docs/reports/phase-4j-2-qa-frontage-runtime-overlay.md`. Phase 4J-3 adds `docs/reports/phase-4j-3-candidate-gap-readiness-report.md` and `scripts/verify-phase-4j-3-candidate-readiness-report.mjs`. Phase 4K adds QA-only recognizable anchor cues, runtime overlay, and local recognizability review. Phase 4L-Prep adds `docs/phase-4l-prep-evidence-gap-to-cue-intake-plan.md`, `docs/phase-4l-prep-qa-evidence-eligibility-contract.md`, `docs/reports/phase-4l-prep-review-gate-report.md`, `src/data/evidence-eligibility/greenpoint-ave-manhattan-to-franklin.phase-4l-prep-qa-evidence-eligibility-contract.v0.1.json`, and `scripts/verify-phase-4l-prep-evidence-eligibility.mjs`. It does not download data, access sources, ingest evidence, expose normal mode, add public UI, add Blender/GLB assets, add Mapillary automation, link businesses/sources, promote QA cues, or promote claims.
...
- Phase 4J-1 QA frontage candidates: `src/data/corridor-scaffold/greenpoint-ave-manhattan-to-franklin.phase-4j-1-qa-frontage-candidates.v0.1.json`
...
56. 4O-12: Existing QA Render Reconnection Boundary. Complete and verified.
57. 4O-13: Existing Render Compatibility Mapping. Complete and verified.
58. 4O-14: QA Scaffold Preview Adapter. Complete and verified.
59. 4O-15: Existing QA Runtime Scaffold Preview. Complete and verified.
60. 4O-16: QA Scaffold Preview Report And Batu Review Gate. Complete and verified.
61. 4O-17: QA scaffold preview legibility pass. Complete and verified.
62. 4O-18: Corridor-wide QA scaffold preview expansion. Complete and verified.
63. 4O-19: QA scaffold preview family controls. Complete and verified.
64. 4O-20: Spatial usefulness review pack. Complete and verified; Batu accepted the 4O-18 -> 4O-20 packet for purposes of opening bounded 4J.
65. 4J-1: Frontage candidate contract + fixture. Complete and verified.
66. 4J-2: QA runtime frontage candidate overlay. Complete and verified.
67. 4J-3: Candidate gap + readiness report. Complete and verified; stop at Batu review gate.
68. 4K-1: Recognizable anchor cue contract + fixture. Complete and verified.
69. 4K-2: QA runtime recognizable anchor overlay. Complete and verified.
70. 4K-3: Local recognizability review pack. Complete and verified; Batu approved the review gate for opening bounded 4L-Prep only.
71. 4L-Prep: Evidence gap to cue eligibility plan. Complete and verified; Batu approved bounded 4L-Local afterward.
72. 4L-Local-1: Local evidence inventory + cue eligibility. Complete and verified.
73. 4L-Local-2: Evidence-backed QA cue enrichment. Complete and verified.
74. 4L-Local-3: QA runtime evidence overlay. Complete and verified.
75. 4L-Local-4: Visual review gate report. Complete and verified.
76. 4L-Local-5: QA layer focus + label-density legibility pass. Complete and verified; stop at Batu review gate.
77. 4M-POC: Existing runtime endpoint fidelity patch. Complete and verified.
78. 4M-POC-R: Existing runtime recognizable-place fidelity refinement. Complete and verified; stop at Batu visual review gate.
79. 4M-POC-R2: Existing runtime evidence-derived benchmark pass. Complete and verified; stop at Batu visual review gate.
80. 4M-R3: Measured hero-corner reconstruction pass. Complete and verified; stop at Batu visual review gate.
81. 4M-R4: Franklin benchmark fidelity convergence pass. Complete and verified; stop at Batu visual review gate.
82. 4M-R5: Franklin hero corner fidelity layer. Complete and verified; stop at Batu visual review gate.
83. 4M-R6: Franklin hybrid benchmark-closure packet. Complete and verified; R6 proved hybrid recognizability but not benchmark render fidelity.
84. 4M-R7: Franklin hero kit extraction + benchmark render proof. Complete and verified; stop at Batu visual review gate.
85. 4M-R8: Franklin data-driven facade assembly proof. Complete and verified; stop at Batu visual review gate.
86. 4M-R9: Franklin high-recognition detail modules. Complete and verified; stop at Batu visual review gate.
87. 4M-R10: Franklin hero asset ingestion spike. Complete for Batu visual review; one QA-only GLB insert, structured record anchoring, procedural fallback, and screenshot comparison captured.
88. 4M-R10A: Franklin placement fix. Complete for Batu visual review; corrected NW/SW/SE QA geometry targets before any further asset-placement decision.
89. 4M-R10B: Franklin spatial reconciliation. Complete but not approved for visual spatial legibility; superseded by R10C/R10D map-truth legibility.
90. 4M-R10C/R10D: Franklin map-truth legibility. Complete but not approved for scene correctness; superseded by R10E actual-scene geometry root-cause fix.
91. 4M-R10E: Franklin scene geometry root-cause fix. Complete for Batu visual review; preserves the R10B footprint mapping, identifies runtime transform/scaffold placement plus centroid-only validation as the issue, adds source-projected building bodies/frontage highlights in `Franklin Scene` QA mode, and captures top-down/oblique/frontage evidence.
92. 4M-R10F: Franklin rendered building + facade/frontage truth pass. Implemented for review; adds solid rendered facade modules in the corrected Franklin-local frame, but not approved for GLB assessment.
93. 4M-R10G: Franklin corner frontage wrap fix. Implemented with saved review screenshots for Batu visual review; adds edge-level Greenpoint/Franklin/corner frontage segments in `Franklin Wrap` QA mode and keeps GLB/R11/R12 blocked.
94. 4M-R11: R9 vs R10 visual/technical comparison. Future candidate only; compare primitive modules, GLB inserts, and mixed hero-kit strategy.
95. 4M-R12: Hero-kit standardization decision. Future candidate only; codify accepted hero-kit boundaries before Manhattan, landmarks, or corridor expansion.
96. Mapillary/KartaView source-use gate. Recommended as a proposal only; not open.
97. 4L external/scaled evidence-backed QA corridor render. Deferred until Batu approves source/evidence boundaries and opens a later packet.
98. 4M production asset registry / visual system / art-direction translation. Deferred until Batu opens production visual-system scope; Qwen/Oxen may be evaluated here only as a source-safe visual-system accelerator.
99. 4N: Normal-mode promotion + recognition QA. Deferred until QA render, spatial scaffold acceptance, provenance, optional asset/art translation, and Batu promotion gates clear.
...
- Blender/GLB assets remain optional enhancement/override layers after the truth-first scaffold. The completed R10 path narrowed that idea to one QA-only Franklin hero insert first: the procedural scaffold remains the base; QA-only hero inserts are exceptions for high-recognition architectural features.
...
- R10E actual-scene geometry review decision: whether the rendered Franklin / Greenpoint Ave building bodies, street slabs, and frontage highlights are spatially correct and recognizable enough before any further GLB assessment/tuning, hero-kit tuning, R11 comparison, R12 standardization, Manhattan work, production mode, facade polish, materials, or asset fidelity. Manhattan remains closed except narrow regression capture if shared renderer code changes.
- R10 visual review decision: whether the controlled one-asset Franklin hero ingestion spike improves recognizable stylized fidelity enough to justify R11 comparison.
- Future 4M-R11 decision: whether primitive modules, GLB inserts, or a mixed hero-kit strategy should become standard for Franklin/Manhattan/landmark exceptions.
- Future 4M-R12 decision: accepted hero-kit boundary, including when PBR/material registry/UV mapping becomes appropriate, before any wider corridor expansion.
- Batu visual/review gate for the completed 4I-4 correction.
- Batu review decision after 4L-Local-4: whether the repo-local evidence pipeline improved the scene enough to justify Mapillary/KartaView as the next scaling lane.
- Batu decision on future source access, download/cache/conversion/render-use boundaries, source fixtures, dependencies/tooling, architecture boundaries, and spatial recognizability acceptance criteria.
