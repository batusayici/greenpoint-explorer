# Decision Log — Pre-Reset Archive (2026-05-26 → 2026-06-04)

History from before the 2026-06-11 project reset. **Not authority** — the current regime is defined by the reset entry and newer in `docs/DECISION_LOG.md`. Preserved verbatim for provenance.
