...
2026-08-17).** It ships weekly, **sent by Batu** (§7 unchanged). **Send day
moved to Thursday, 7:00am New York, first send Thu Sep 17 (Batu, 2026-09-13;
DECISION_LOG that date).** The list is parents-majority and its two most-opened
cards were weekend events, so the email leads with the weekend and lands when the
weekend is being planned; content is also freshest after the Wednesday pull. Two
editions go out, one per follow segment — Family & Kids and Greenpoint — as Gmail
drafts the operator composes and Batu sends; the mechanism, the 5-subscriber
rule for a lens earning its own edition, and the template live in
`docs/growth/digest.md`. *(Prior text, kept as the record: "ships weekly to the
full list from Mon Aug 24, drafted by the Monday routine" — no send ever
happened under it; see learning log L2026-09-13.)* Follow remains the CTA and
