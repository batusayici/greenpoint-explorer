...
Current work packet: post-4D-4 facade evidence packet review state.
...
Post-4D-4 direction: the proposed next authorization is `Batch 4D-5: Evidence-backed facade/storefront anchors`, only after Batu reviews the 4D-4 output.

Hard review gate: stop for Batu review of 4D-4. Do not self-open 4D-5 or any later Phase 4 batch.
