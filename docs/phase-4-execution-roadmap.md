...
Current work packet: post-4D-3 candidate POI QA review state.
...
Post-4D-3 direction: the proposed next authorization is `Batch 4D-4: Batu-supplied facade evidence packet`, only after Batu reviews the 4D-3 output.

Hard review gate: stop for Batu review of 4D-3. Do not self-open 4D-4 or any later Phase 4 batch.
