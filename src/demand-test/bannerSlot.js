...
// distant-closure FYI chip > empty. The feed pin for a community alert's card
// is independent of this slot: the campaign stays elevated in the feed even
// while a closure weekend holds the banner.
export function bannerSlot(gtrainPhase, communityAlert) {
